...
function renderAllImages() {
    ...
    categories.forEach(cat => {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            // 先绑定事件，再设置 src（避免缓存图片 onload 丢失）
            img.onload = function () {
    ...
    heroBgImg.src = 'images/hero-bg.jpg';
...
function setupScrollAnimations() {
    ...
    document.querySelectorAll('.project-header, .about-content, .contact-form, .contact-info').forEach(el => {
        el.style.opacity = '0';
